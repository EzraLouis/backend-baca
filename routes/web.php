...
Route::middleware(['auth'])->group(function () {
    Route::get('home', function () {
        return view('pages.app.dashboard-baca', ['type_menu' => '']);
    })->name('home');
    Route::get('/users', [UserController::class, 'index']);
    Route::view('/index', 'pages\users\index')
        ->name('index');
...
//     Route::view('list-renungan', 'pages.app.list-renungan')
//         ->name('list-renungan');
//     Route::view('tambah-renungan', 'pages.app.tambah-renungan')
//         ->name('tambah-renungan');
//     Route::view('edit-renungan', 'pages.app.edit-renungan')
//         ->name('edit-renungan');
//     Route::resource('user', UserController::class);
